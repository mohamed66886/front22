    ...
    try {
      ...
      if (uploadMethod === "url" && formData.logo_url.trim()) {
        ...
        try {
          ...
          setError("فشل رفع الصورة. تأكد من أن الباك إند يعمل. سيتم حفظ الجامعة بدون لوجو.");
          // Continue without logo
          logoUrl = undefined;
        }
      }

      // Create university with logo URL
      startTransition(() => {
        addUniversity({
      ...
      const errorMessage = err instanceof Error ? err.message : "حدث خطأ أثناء إضافة الجامعة. يرجى المحاولة مرة أخرى.";
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-200px)]">
        <div className="w-full max-w-3xl">
          ...
          <div className="mb-6">
            ...
            >
              قم بإدخال بيانات الجامعة الجديدة
            </p>
          </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 text-right">
                        ...
                        >
                          {logoFile && `${(logoFile.size / 1024).toFixed(2)} كيلوبايت`}
                        </p>
                      </div>
                      <button
                        type="button"
